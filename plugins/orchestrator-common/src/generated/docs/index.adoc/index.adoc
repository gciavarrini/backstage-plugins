...
[.retriggerInstanceById]
==== retriggerInstanceById

`POST /v2/workflows/instances/{instanceId}/retrigger`
...
// markup not found, no include::{specDir}v2/workflows/instances/\{instanceId\}/retrigger/POST/spec.adoc[opts=optional]
...
| 500
| Error retriggering instance in error
|  <<ErrorResponse>>
...
// markup not found, no include::{snippetDir}v2/workflows/instances/\{instanceId\}/retrigger/POST/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}v2/workflows/instances/\{instanceId\}/retrigger/POST/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :v2/workflows/instances/{instanceId}/retrigger/POST/POST.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}v2/workflows/instances/\{instanceId\}/retrigger/POST/implementation.adoc[opts=optional]
