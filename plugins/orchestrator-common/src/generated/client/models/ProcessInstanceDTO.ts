...
export function ProcessInstanceDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProcessInstanceDTO {
    ...
    return {
        ...
        'workflowdata': !exists(json, 'workflowdata') ? undefined : WorkflowDataDTOFromJSON(json['workflowdata']),
    };
}

export function ProcessInstanceDTOToJSON(value?: ProcessInstanceDTO | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
