...
export function WorkflowCategoryDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkflowCategoryDTO {
    return json as WorkflowCategoryDTO;
}

export function WorkflowCategoryDTOToJSON(value?: WorkflowCategoryDTO | null): any {
    return value as any;
}
