...
export function WorkflowListResultDTOFromJSON(json: any): WorkflowListResultDTO {
    return WorkflowListResultDTOFromJSONTyped(json, false);
}

export function WorkflowListResultDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkflowListResultDTO {
...
export function WorkflowListResultDTOToJSON(value?: WorkflowListResultDTO | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
