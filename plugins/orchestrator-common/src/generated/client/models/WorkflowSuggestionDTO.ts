...
export function WorkflowSuggestionDTOFromJSON(json: any): WorkflowSuggestionDTO {
    return WorkflowSuggestionDTOFromJSONTyped(json, false);
}

export function WorkflowSuggestionDTOFromJSONTyped(json: any, ignoreDiscriminator: boolean): WorkflowSuggestionDTO {
...
export function WorkflowSuggestionDTOToJSON(value?: WorkflowSuggestionDTO | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
