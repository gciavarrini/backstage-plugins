...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        executeWorkflow: async (workflowId: string, body: any, businessKey?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workflowId' is not null or undefined
            assertParamExists('executeWorkflow', 'workflowId', workflowId)
            // verify required parameter 'body' is not null or undefined
            assertParamExists('executeWorkflow', 'body', body)
         ...
         * @throws {RequiredError}
         */
        retriggerInstanceById: async (instanceId: string, body: any, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'instanceId' is not null or undefined
            assertParamExists('retriggerInstanceById', 'instanceId', instanceId)
            // verify required parameter 'body' is not null or undefined
            assertParamExists('retriggerInstanceById', 'body', body)
            const localVarPath = `/v2/workflows/instances/{instanceId}/retrigger`
                .replace(`{${"instanceId"}}`, encodeURIComponent(String(instanceId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async executeWorkflow(workflowId: string, body: any, businessKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExecuteWorkflowResponseDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.executeWorkflow(workflowId, body, businessKey, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async retriggerInstanceById(instanceId: string, body: any, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExecuteWorkflowResponseDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.retriggerInstanceById(instanceId, body, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['DefaultApi.retriggerInstanceById']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        executeWorkflow(workflowId: string, body: any, businessKey?: string, options?: any): AxiosPromise<ExecuteWorkflowResponseDTO> {
            return localVarFp.executeWorkflow(workflowId, body, businessKey, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get Workflow Instance by ID
         ...
         * @throws {RequiredError}
         */
        retriggerInstanceById(instanceId: string, body: any, options?: any): AxiosPromise<ExecuteWorkflowResponseDTO> {
            return localVarFp.retriggerInstanceById(instanceId, body, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public executeWorkflow(workflowId: string, body: any, businessKey?: string, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).executeWorkflow(workflowId, body, businessKey, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public retriggerInstanceById(instanceId: string, body: any, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).retriggerInstanceById(instanceId, body, options).then((request) => request(this.axios, this.basePath));
    }
}
